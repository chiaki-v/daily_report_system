...
<select name="${AttributeConst.EMP_ADMIN_FLG.getValue()}">
    ...
    <option value="${AttributeConst.ROLE_SYSTEM_ADMIN.getIntegerValue()}"<c:if test="${employee.adminFlag == AttributeConst.ROLE_SYSTEM_ADMIN.getIntegerValue()}"> selected</c:if>>システム管理者</option>
</select>
<br /><br />
